            ...
            <div className='mx-6 py-5 text-4xl rounded-md flex flex-col items-center bg-gradient-to-r from-purple-800 to-purple-950 text-white mt-4 '>
                ...
                <div className='bg-white text-gray-600 flex items-center justify-between rounded mt-3 pl-3 mx-2 sm:mx-auto max-w-xl max-sm:w-[95%]'>
                    <div className='flex items-center text-lg gap-1 flex-grow min-w-0'>
                        ...
                        <input ref={titleRef} className="max-sm:text-xs placeholder:text-gray-800 outline-none w-full flex-grow" type="text" name="" id="" placeholder='Search for Jobs' />
                    </div>
                    ...
                    <div className='flex items-center text-lg gap-1 flex-grow min-w-0'>
                        ...
                        <input ref={locationRef} className="max-sm:text-xs placeholder:text-gray-800 outline-none w-full flex-grow" type="text" name="" id="" placeholder='Location' />
                    </div>

                    <button onClick={refUpdated} className='bg-blue-600 px-3 py-2 rounded text-white m-1 text-sm flex-none ml-auto'>
                        Search
                    </button>
                </div>
